  ...
  return (
    <div className={` ${InputSize[size]} flex flex-col gap-2`}>
      ...
      <div className={`relative`}>
        ...
        } pr-[10px] leading-[21px] text-black placeholder:text-darkGray border-darkGray bg-inputBackground border rounded-[6px] focus:border-darkBlue  focus:outline-none focus:ring focus:ring-darkBlue focus:ring-opacity-30`}
          disabled={isDisabled}
        />
